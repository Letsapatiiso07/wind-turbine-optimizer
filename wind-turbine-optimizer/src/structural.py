"""
Structural Analysis and Fatigue Module

Implements 1D beam model for blade deflections and stresses.
Includes fatigue damage calculation using rainflow counting and Miner's rule.
"""
