"""
Blade Geometry Parameterization Module

Defines wind turbine blade geometry using minimal physically meaningful parameters.
Supports chord, twist, and airfoil distributions along the span.
"""
